    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content needs-validation" >
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Data Toko</h1>
            ...
            <div class="modal-body">
                ...
                <div class=" row mb-1">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="MsWorkplaceCode" name="MsWorkplaceCode" class="form-control form-control-sm" value="<?= $toko["MsWorkplaceCode"]?>" required> 
                    </div>
                </div>
                <div class=" row mb-1">
                    <label for="MsWorkplaceName" class="col-sm-4 col-form-label">Nama</label>
                    <div class="col-sm-8">
                        <input type="text" id="MsWorkplaceName" name="MsWorkplaceName" class="form-control form-control-sm" value="<?= $toko["MsWorkplaceName"]?>"/>
                    </div>
                </div>
                <div class=" row mb-1">
                    <label for="MsWorkplaceAddress" class="col-sm-4 col-form-label">Alamat</label>
                    <div class="col-sm-8">
                        <textarea id="MsWorkplaceAddress" name="MsWorkplaceAddress" class="form-control form-control-sm" value=""><?= $toko["MsWorkplaceAddress"]?></textarea>
                    </div>
                </div>  
                <div class=" row mb-1">
                    <label for="MsWorkplaceTelp1" class="col-sm-4 col-form-label">Telp1</label>
                    <div class="col-sm-8">
                        <input type="text" id="MsWorkplaceTelp1" name="MsWorkplaceTelp1" class="form-control form-control-sm number-hp" value="<?= $toko["MsWorkplaceTelp1"]?>"/>
                    </div>
                </div>  
                <div class=" row mb-1">
                    <label for="MsWorkplaceTelp2" class="col-sm-4 col-form-label">Telp2</label>
                    <div class="col-sm-8">
                        <input type="text" id="MsWorkplaceTelp2" name="MsWorkplaceTelp2" class="form-control form-control-sm number-hp" value="<?= $toko["MsWorkplaceTelp2"]?>"/>
                    </div>
                </div>  
                <div class=" row mb-1">
                    <label for="MsWorkplaceEmail" class="col-sm-4 col-form-label">Email</label>
                    <div class="col-sm-8">
                        <input type="text" id="MsWorkplaceEmail" name="MsWorkplaceEmail" class="form-control form-control-sm" value="<?= $toko["MsWorkplaceEmail"]?>"/>
                    </div>
                </div>    
                <div class=" row mb-1">
...
<script> 
    ...
    $("#btn-submit").click(function(){ 
        ...
        $.ajax({
            method: "POST",
            dataType: "json",
            url: "<?= base_url("admin/toko/edit/") ?>" + '<?= $toko["MsWorkplaceId"] ?>',
            data: {
